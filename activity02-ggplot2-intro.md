...
**Response**: Adding the colo option in aes adds outlines each boxplot
with a color representing the specified class in this case species.
...
**Response**: You can easily see the 5-number summary (min, Q1, median,
Q3, max) when creating a boxplot. The jitterplot shows the individual
observations.
